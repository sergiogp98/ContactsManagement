    ...
    try{
        ...
        if(!empty){
            ...
            while(filmIndex < dataOBJ.films.length){
                let filmYear = dataOBJ.films[filmIndex].year; 
                if(filmYear == year){
            ...
            if(numberFilms != dataOBJ.films.length){
                ...
                return {'success': true, 'message': 'Some films were deleted by its year'};
            }else{
                return {'success': false, 'message': 'No films were deleted by its year'};
            }
        }else{
